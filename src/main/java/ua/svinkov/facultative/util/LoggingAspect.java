...
public class LoggingAspect {
	...
	@Pointcut("within(ua.svinkov.facultative.entity..*)" + " || within(ua.svinkov.facultative.service..*)"
			+ " || within(ua.svinkov.facultative.controller..*)" + " || within(ua.svinkov.facultative.util..*)")
